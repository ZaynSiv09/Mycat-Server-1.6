...
public abstract class FrontendConnection extends AbstractConnection {
	...
	public void initDB(byte[] data) throws IntrospectionException, InterruptedException, KeeperException {
	...
	public void query(String sql) throws IntrospectionException, InterruptedException, KeeperException {
	...
	public void query(byte[] data) throws IntrospectionException, InterruptedException, KeeperException {
	...
	public void stmtExecute(byte[] data) throws IntrospectionException, InterruptedException, KeeperException {
		if (prepareHandler != null) {
	...
	@Override
	public void register() throws IOException, IntrospectionException, InterruptedException, KeeperException {
		if (!isClosed.get()) {
	...
	public void rawHandle(final byte[] data) throws IntrospectionException, InterruptedException, KeeperException {
