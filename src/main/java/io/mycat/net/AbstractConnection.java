...
public abstract class AbstractConnection implements NIOConnection {
	...
	@Override
	public void handle(byte[] data) throws IntrospectionException, InterruptedException, KeeperException {
	...
	public void asynRead() throws IOException, IntrospectionException, InterruptedException, KeeperException {
	 ...
	 * 读取可能的Socket字节流
	 */
	public void onReadData(int got) throws IOException, IntrospectionException, InterruptedException, KeeperException {
